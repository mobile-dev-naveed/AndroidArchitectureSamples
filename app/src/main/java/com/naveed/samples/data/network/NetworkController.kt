...
class NetworkController private constructor() {
    ...
    companion object {
        private var sNetworkController: NetworkController? = null


        val instance: NetworkController
            get() {
                if (sNetworkController == null) {
                    sNetworkController = newInstance
                }
                return sNetworkController!!
            }

        private val newInstance: NetworkController
            @Synchronized get() = sNetworkController ?: NetworkController()
    }
